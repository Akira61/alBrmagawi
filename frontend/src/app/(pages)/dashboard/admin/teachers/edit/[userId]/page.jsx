...
export default function EditTeacher({params}) {
  ...
  async function getData(id){
    try {
      const {data} = await axios.get('/api/dashboards/admin/teachers/all/'+id);
      if(data.success){
        ...
        setPosition(data.data.designation)
  ...
  async function onsubmit(e){
    e.preventDefault();
    try {
      const {data} = await axios.post('/api/dashboards/admin/teachers/edit',{
        userId : userId,
      ...
      if(data.success){
        route.push(configURL.dashboard.admin.teacher.all)
      }
    } catch (error) {
      console.log(error)
    }
