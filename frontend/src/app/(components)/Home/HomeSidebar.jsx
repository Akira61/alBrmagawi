...
export default function HomeSidebar() {
  return (
    <div>
      ...
      <>
        <nav className="fixed top-0 z-50 w-full bg-jaguar border-b border-blue-sapphire">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start">
                ...
                <a href="https://flowbite.com" className="flex ml-2 md:mr-24">
                  <span className="self-center px-3 text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
                    Cybarani
                  </span>
                </a>
              </div>
        ...
        <aside
          id="logo-sidebar"
          className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-jaguar border-r border-blue-sapphire sm:translate-x-0"
          aria-label="Sidebar"
        >
          <div className="h-full px-3 py-2 overflow-y-auto">
            <ul className="space-y-4 nomarker font-medium">
              {[
                ...
                <li key={href}>
                  <Box active={false}>
                    <a href={href} className="flex items-center p-4 rounded-lg">
                      {icon}
