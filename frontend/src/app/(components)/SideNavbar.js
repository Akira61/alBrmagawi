...
//             <img
//               src="/logo.png"
//               className={`cursor-pointer w-56 mb-5 duration-500 ${
//                 open && "rotate-[360deg]"
//               }`}
//             />
//             {/* <h1
...
//             <li
//               className={`flex rounded-md p-2 cursor-pointer hover:bg-light-white text-gray-300 text-lg font-semibold items-center gap-x-4`}
//             >
...
//                   className={`${
//                     !open && "hidden"
//                   } origin-left duration-200  hover:bg-slate-600 focus:ring-4  focus:outline-none font-medium rounded-lg text-lg px-4 py-2.5 text-center inline-flex items-center`}
...
//                 <div
//                   id="dropdown"
//                   className={`z-10 w-44 bg-slate-600 rounded divide-y divide-gray-800 shadow ${
//                     isDropdownOpen ? "block" : "hidden"
//                   }`}
//                 >
//                   <ul className=" z-10 w-44 bg-slate-600 rounded-md divide-y divide-gray-600 shadow ">
//                     <li>
//                       <a
//                         href="#"
